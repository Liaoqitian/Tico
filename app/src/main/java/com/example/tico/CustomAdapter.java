...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        /* @Qitian
           Here you should declare the views that are included in the card_layout.xml and initialize them
           in the MyViewHolder constructor. In the CustomAdapter constructor, you pass in the data that
           you collected through the API calls in MainActivity (I added code use can use as reference there)
           along with anything else you might need
           Towards the bottom you will also see a method called onBindViewHolder.
           In that method you can set the text/image of the views accordingly using the data
         */
